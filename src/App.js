...
import { Col, Row, Pagination, PaginationItem, PaginationLink, Form, FormGroup, Label, Input, FormText, Button } from 'reactstrap';
            ...
            <Row>
              <Col md={3} className='page_bar'>
                ...
                <Pagination aria-label="Page navigation example">
                  ...
                  <PaginationItem>
                    <PaginationLink onClick={() => { this.changePage(1) }} href="#">1</PaginationLink>
                  </PaginationItem>
                  <PaginationItem>
                    <PaginationLink onClick={() => { this.changePage(2) }} href="#"> 2</PaginationLink>
                  </PaginationItem>
                  <PaginationItem>
                    <PaginationLink onClick={() => { this.changePage(3) }} href="#"> 3</PaginationLink>
                  </PaginationItem>
                  <PaginationItem>
                    <PaginationLink onClick={() => { this.changePage(4) }} href="#">4  </PaginationLink>
                  </PaginationItem>
                  <PaginationItem>
                    <PaginationLink onClick={() => { this.changePage(5) }} href="#"> 5</PaginationLink>
                  </PaginationItem>
                  <PaginationItem>
